...
const useDestinationModel = () => {
  ...
  const getDataDestination = () => destinations;
  ...
  return {
    ...
    sortByRating,
    resetData, // tuỳ chọn
    getDataDestination, // added method
    data: destinations, // alias for destinations
    row: selectedDestination, // alias for selectedDestination
  };
};
